      ...
      <div className="productDescriptionContainer">
        <div className="flexRow">
          <div className="verticalImageStack">
            {
              product.productDetails.pictures.map((thumb, index) =>
          ...
          <div className="productDescContainer">
            <div className="productDescImgContainer">
              <img height="400px" src={generatePublicUrl(product.productDetails.pictures[0].img)} alt={`${product.productDetails.pictures[0].img}`} />
            </div>
            {/* action buttons */}
            <div className="flexRow">
              <MaterialButton
                ...
                onClick={()=>{
                  ...
                  const img=product.productDetails.pictures[0].img;
